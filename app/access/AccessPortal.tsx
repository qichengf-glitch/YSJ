...
const copy = {
  en: {
    ...
    dataTitle: "A-Share Strategy Panel",
    dataDescription: "Tick-stock-panel workspace backed by the internal ClickHouse market data API.",
    dataCadence: "1-minute / daily",
    dataStatus: "Panel",
    dataBullets: ["Stock screening monitor", "Intraday strategy workspace", "Backtest-ready data contract"],
    open: "Open",
    logout: "Sign out",
  },
  zh: {
    ...
    dataTitle: "A股策略监控面板",
    dataDescription: "接入内部 ClickHouse 行情 API 的 tick-stock-panel 工作台。",
    dataCadence: "1 分钟 / 日线",
    dataStatus: "面板",
    dataBullets: ["选股监控", "分钟级策略工作台", "可服务回测的数据契约"],
    open: "打开",
    logout: "退出登录",
  },
};
